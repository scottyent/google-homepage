/*! For license information please see tutorial.0254264c6aef98c41715.js.LICENSE.txt */
...
var g = h[f], m = g.inside, v = !!g.lookbehind, b = !!g.greedy, y = g.alias;
...
let f, g, m, v = n.classList.contains("language-javascript"), b = n.classList.contains("language-markup"), y = +e.getAttribute("data-trusted"), E = !+e.getAttribute("data-no-strict") && v ? '"use strict";' : "", w = 'globalThis.__codeBoxId = "'.concat(e.id, '";');
d = "".concat(E).concat(w, "\n\n").concat(d);
let _ = !0;
if (!v && !b) return;
...
function F() {
t && (t.remove(), t = null), v ? T() : function() {
let t;
...
e.exports = function(e, t, n) {
var l, c, u, d, p, h, f = 0, g = !1, m = !1, v = !0;
if ("function" != typeof e) throw new TypeError("Expected a function");
function b(t) {
var n = l, r = c;
...
function y(e) {
return f = e, p = setTimeout(w, t), g ? b(e) : d;
}
function E(e) {
var n = e - h;
...
v = "trailing" in n ? !!n.trailing : v), S.cancel = function() {
...
e = o)) : (Q = e, e = o), e === a && (e = Q, (n = he()) !== a && (ee = e, n = v(n)), 
e = n), e;
}
function he() {
var e, n, r, i, s, l;
if (e = Q, 61 === t.charCodeAt(Q) ? (n = b, Q++) : (n = a, 0 === ie && le(y)), n !== a) {
...
n !== a && (r = ve()) !== a ? (ee = e, e = n = D(r)) : (Q = e, e = o), e;
}
function me() {
var e, n, r, i;
return e = Q, t.substr(Q, 2) === M ? (n = M, Q += 2) : (n = a, 0 === ie && le(B)), 
n !== a && (r = ve()) !== a ? (125 === t.charCodeAt(Q) ? (i = j, Q++) : (i = a, 
...
n !== a) {
if (r = [], (i = ve()) !== a) for (;i !== a; ) r.push(i), i = ve(); else r = o;
...
//# sourceMappingURL=tutorial.0254264c6aef98c41715.js.map